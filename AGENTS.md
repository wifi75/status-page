...
- Database SQLite (dialetto `hibernate-community-dialects`). Schema solo tramite Flyway (`src/main/resources/db/migration`), `ddl-auto: validate`. Mai modificare una migrazione già rilasciata: aggiungerne una nuova.
...
- Prima di un commit: `./mvnw verify`.
